...
const Table3: FC = () => {
    ...
    const columns: GridColumns = [
        ...
        {
            field: 'field1',
            headerName: 'Наименование и тип средства защиты информации, заводской (инвентарный) номер',
            width: 170,
            editable: true,
            type: "string",
            headerAlign: 'center'
        ...
        {
            field: 'field2',
            headerName: 'Сведения о сертификате соответствия5',
            width: 170,
            editable: true,
            type: "string",
            headerAlign: 'center'
        ...
        {
            field: 'field3',
            headerName: 'Номер знака соответствия',
            width: 115,
            editable: true,
            type: "string",
            headerAlign: 'center'
    ...
    return(
        <React.Fragment>
            <Typography variant={'body1'} textAlign={'right'}>Таблица 3</Typography>
